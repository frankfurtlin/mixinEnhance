...
public abstract class DrownedEntityMixin {
    ...
    private float drownedSpawnWithShell(float constant){
        ...
        return (float) ModMenuConfig.INSTANCE.entityModuleConfig.hostileMobConfig.drownedSpawnWithShell;
    }
    ...
    private static int drownedSpawnInRiverFactor(int constant){
        ...
        return constant / ModMenuConfig.INSTANCE.entityModuleConfig.hostileMobConfig.drownedSpawnFactor;
    }
    ...
    private double drownedSpawnWithTool(double constant){
        ...
        return 1 - ModMenuConfig.INSTANCE.entityModuleConfig.hostileMobConfig.drownedSpawnWithTool;
    }
