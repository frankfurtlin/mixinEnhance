...
public abstract class MobEntityMixin {
    ...
    private float spawnEquipmentChance(float chance) {
        ...
        return (float) MixinEnhanceClient.getConfig().entityModuleConfig.mobConfig.spawnEquipmentChance;
    }
    ...
    private float enchantmentArmorStrength(float chance) {
        ...
        return (float) MixinEnhanceClient.getConfig().entityModuleConfig.mobConfig.enchantmentArmorStrength;
    }
    ...
    private float armorAndHandDropChance(float chance) {
        ...
        return (float) MixinEnhanceClient.getConfig().entityModuleConfig.mobConfig.armorAndHandDropChance;
    }
